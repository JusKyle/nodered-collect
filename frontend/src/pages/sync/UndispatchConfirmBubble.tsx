...
import { undeployConfig } from '../../api/sync.api'
import { useDeviceInstanceStore } from '../../stores/device-instance.store'
import { showToast } from '../../utils/toast'

interface UndispatchConfirmBubbleProps {
  instance: DeviceInstance
  onUndispatchSuccess: () => void
}

function UndispatchConfirmBubble({ instance, onUndispatchSuccess }: UndispatchConfirmBubbleProps) {
  ...
  const handleUndeploy = async () => {
    ...
    try {
      ...
      await updateDeviceInstance(instance.id, { status: 'OFFLINE' })
      setShowBubble(false)
    ...
    <div className="relative inline-block">
      ...
      {showBubble && (
        <>
          ...
          />
          <div className="absolute left-0 top-full mt-2 z-20 w-80 bg-white rounded-lg shadow-lg border border-gray-200 p-4">
...
export default UndispatchConfirmBubble